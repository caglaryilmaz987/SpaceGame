 ...
 * @author cagla
 */
public class NuclearPlanet extends Planet {

    Random random = new Random();
    Scanner scanner = new Scanner(System.in);

    public NuclearPlanet(String name, String atmosphere, int gravity, Metal metal, Uranium uranium, RepconnSpaceRocket rocket) {
...
// I want to make resource extraction different for each planet, that's why I'm overriding the general abstract method
    ...
    public void collectResources(RepconnSpaceRocket rocket) {
        ...
        if (rocket.getFuelStatus() < 5 && rocket.getHellFire().quantity <= 0 && rocket.getX_01().quantity <= 0 && rocket.getX_02().quantity <= 0) {
...
// A method is needed to return planet information
    @Override
